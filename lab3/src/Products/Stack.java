 ...
 * Time: 17:08
 */
public class Stack<E extends IProduct> {
    ...
    public Object getProduct(int index) throws IndexOutOfBoundsException {
        //if (index < 0 || index >= containerCount) throw ne
        return mContainer[index];
    }

    public Iterator objectsReverse() {
